...
; Background tiles
DEF EMPTY_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 0

; Wall tiles
DEF TOP_WALL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 2
DEF LEFT_WALL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 4
DEF RIGHT_WALL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 5
DEF BOTTOM_WALL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 7

; Body tiles
DEF SNAKE_BODY_HORIZONTAL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 1
DEF SNAKE_BODY_VERTICAL_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 3
DEF SNAKE_BODY_LEFT_TO_TOP_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 4
DEF SNAKE_BODY_LEFT_TO_DOWN_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 0
DEF SNAKE_BODY_RIGHT_TO_TOP_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 5
DEF SNAKE_BODY_RIGHT_TO_DOWN_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 2

; Tail tiles
DEF SNAKE_TAIL_LEFT_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 6
DEF SNAKE_TAIL_RIGHT_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 7
DEF SNAKE_TAIL_DOWN_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 8
DEF SNAKE_TAIL_UP_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 9

; Apple tile
DEF APPLE_TILE_ID EQU FONT_NUMBER_OF_TILES_IN_MEMORY + 9 + 10
